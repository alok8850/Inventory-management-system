...
class categoryclass:
    def __init__(self,root):
        self.root=root
        self.root.geometry("1200x550+200+145")  # 1100x500+250+180 previous dimension
        ...
        #----------
        lbl_title=Label(self.root,text="Manage Product Category",font=("goudy old style",30,"bold"),bg="#184a45",fg="white",bd=3,relief=RIDGE).pack(side=TOP,fill=X,padx=15,pady=20)
        ...
        self.category_table=ttk.Treeview(cate_frame,columns=("cid","name"),yscrollcommand=scrolly.set,xscrollcommand=scrollx.set)
        ...
        self.im1=self.im1.resize((500,250),Image.BICUBIC)    #antialias is been replaces with bicubic bcz antialias is slow.
        ...
        self.im2=self.im2.resize((500,250),Image.BICUBIC)    #antialias is been replaces with bicubic bcz antialias is slow.
    ...
    def delete(self):
        ...
        try:
            if self.var_cat_id.get()=="" :
                ...
                row=cur.fetchone()
                if row==None:
                    messagebox.showerror("Error","Error,try with different",parent=self.root)
                else:
